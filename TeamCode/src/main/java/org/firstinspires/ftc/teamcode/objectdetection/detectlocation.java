...
@TeleOp(name="Location Detector", group="Tester TeleOp")

public class detectlocation extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if(myPipeline.getRectArea() > 2000){
                ...
                if(rectMidpointX > 2 * screenThird){
                    ...
                    AUTONOMOUS_C(); // Object is on the right edge
                }
                else if(rectMidpointX > screenThird){
                    telemetry.addLine("OBJECT IS IN THE MIDDLE");
                    AUTONOMOUS_B(); // Object is in the middle third
                }
                else {
                    telemetry.addLine("OBJECT IS ON THE LEFT SIDE");
                    AUTONOMOUS_A(); // Object is on the left edge
                }
            }
        }
